...
class VolumeOperator
    : public wmtk::operations::SingleAttributeTransferStrategy<MyType, ParentType, 1, ParentDim>
{
public:
    using BaseType =
        wmtk::operations::SingleAttributeTransferStrategy<MyType, ParentType, 1, ParentDim>;
