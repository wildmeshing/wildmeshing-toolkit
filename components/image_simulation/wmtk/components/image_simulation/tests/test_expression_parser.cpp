...
TEST_CASE("test_parser_all", "[image_simulation],[expression_parser]")
{
...
TEST_CASE("test_parser_and", "[image_simulation],[expression_parser]")
{
    const auto expr = parse("A & B & C", tag_name_to_id);
    // logger().info("Expression string: {}", expr->to_string());
...
TEST_CASE("test_parser_empty", "[image_simulation],[expression_parser]")
{
...
TEST_CASE("test_parser_not_empty", "[image_simulation],[expression_parser]")
{
...
TEST_CASE("test_parser_priority", "[image_simulation],[expression_parser]")
{
...
TEST_CASE("test_parser_contains", "[image_simulation],[expression_parser]")
{
    const auto expr = parse("A & (B | !C)", tag_name_to_id);
    // logger().info("Expression string: {}", expr->to_string());
...
TEST_CASE("test_parser_tags_involved", "[image_simulation],[expression_parser]")
{
    const auto expr = parse("A & (B | !C)", tag_name_to_id);
    logger().info("Expression string: {}", expr->to_string());
