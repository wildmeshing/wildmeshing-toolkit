...
std::vector<ConnectedComponent> ImageSimulationMeshTri::compute_connected_components(
...
std::vector<ConnectedComponent> ImageSimulationMeshTri::find_holes(
...
void ImageSimulationMeshTri::compute_tag_boundary(const CellTag& tag, MatrixXd& V, MatrixXi& E)
    const
{
...
void ImageSimulationMeshTri::seal_connected_components(
...
void ImageSimulationMeshTri::keep_largest_connected_component(
...
void ImageSimulationMeshTri::resolve_intersections(const std::vector<CellTag>& intersecting_tags)
{
