...
[
  ...
  },
  {
    ...
    "default": [["tag_0"]],
    "min": 1,
    "doc": "List of tag sets. The intersection of the union of each set will be offset. Eg, [['tag_0'], ['tag_1', 'tag_2']] offsets the intersection between tag 0 and the union of tags 1 and 2."
  },
  {
    "pointer": "/offset_tags/*",
    "type": "list",
  ...
  },
  {
    ...
    "type": "bool",
    "default": false,
    "doc": "Only relevant for single body offset (e.g. [['tag_0']]. Whether to create offset inside body"
  },
  {
    "pointer": "/offset_out",
    "type": "bool",
    "default": true,
    "doc": "Only relevant for single body offset (e.g. [['tag_0']]. Whether to create offset outside body"
  },
  {
  ...
  },
  {
    ...
    "type": "list",
    "default": [],
    "doc": "List of tags which will not be overwritten in any scenario."
  },
  {
    "pointer": "/protected_tags/*",
    "type": "string",
