...
double wmtk::AMIPS2D_energy(const std::array<double, 6>& T)
{
    double helper_0[6];
    helper_0[0] = T[0];
    helper_0[1] = T[1];
...
void wmtk::AMIPS2D_jacobian(const std::array<double, 6>& T, Eigen::Vector2d& result_0)
{
    double helper_0[6];
    helper_0[0] = T[0];
    helper_0[1] = T[1];
...
void wmtk::AMIPS2D_hessian(const std::array<double, 6>& T, Eigen::Matrix2d& result_0)
{
    double helper_0[6];
    helper_0[0] = T[0];
    helper_0[1] = T[1];
...
// double wmtk::AMIPS2D_energy(const feature::FeatureElement &feature, const double t, const
...
//     return wmtk::AMIPS2D_energy(tmp);
// }

// double wmtk::AMIPS2D_jacobian(const feature::FeatureElement &feature, const double t, const
// std::array<double, 6>& T)
// {
//     const auto pt = feature.eval(t);
//     const std::array<double, 6> tmp = {{
...
//     Eigen::Vector2d JE;
//     AMIPS2D_jacobian(tmp, JE);
//     const auto gamma_prime = feature.eval_first_derivative(t);

//     return JE(0)*gamma_prime.x + JE(1)*gamma_prime.y;
// }

// double wmtk::AMIPS2D_hessian(const feature::FeatureElement &feature, const double t, const
// std::array<double, 6>& T)
// {
//     const auto pt = feature.eval(t);
//     const std::array<double, 6> tmp = {{
...
//     Eigen::Matrix2d HE;
//     AMIPS2D_jacobian(tmp, JE);
//     AMIPS2D_hessian(tmp, HE);

//     const auto gamma_prime = feature.eval_first_derivative(t);
//     const auto gamma_second = feature.eval_second_derivative(t);

//     const double gp_H_gp =
//     (HE(0,0)*gamma_prime.x+HE(1,0)*gamma_prime.y)*gamma_prime.x+(HE(0,1)*gamma_prime.x+HE(1,1)*gamma_prime.y)*gamma_prime.y;
