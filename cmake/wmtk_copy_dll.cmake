...
function(wmtk_get_dependencies_recursive OUTPUT_VARIABLE TARGET)
    ...
    foreach(DEPENDENCY IN ITEMS ${TARGET_DEPENDENCIES})
        if(TARGET ${DEPENDENCY})
            ...
            if(NOT (DEPENDENCY IN_LIST VISITED_TARGETS))
                ...
                wmtk_get_dependencies_recursive(VISITED_TARGETS ${DEPENDENCY})
            endif()
        endif()
    endforeach()
...
function(wmtk_get_dependencies OUTPUT_VARIABLE TARGET)
    set(DISCOVERED_TARGETS "")
    wmtk_get_dependencies_recursive(DISCOVERED_TARGETS ${TARGET})
...
function(wmtk_copy_dll target)
    ...
    wmtk_get_dependencies(TARGET_DEPENDENCIES ${target})
