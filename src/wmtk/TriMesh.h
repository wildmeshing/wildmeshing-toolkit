...
protected:
    ...
    // virtual void resize_vertex_attributes(size_t v, size_t e, size_t t) {}
    // virtual void resize_edge_attributes(size_t v, size_t e, size_t t) {}
    // virtual void resize_face_attributes(size_t v, size_t e, size_t t) {}
