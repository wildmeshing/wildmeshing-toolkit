...
template <>
template <typename T>
struct std::hash<wmtk::attribute::TypedAttributeHandle<T>>
{
    ...
    {
        return std::hash<wmtk::attribute::AttributeHandle>{}(handle.m_base_handle);
    }
...
struct std::hash<wmtk::attribute::MeshAttributeHandle<T>>
{
    ...
    {
        return std::hash<wmtk::attribute::TypedAttributeHandle<T>>{}(handle);
    }
