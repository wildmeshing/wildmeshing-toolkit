...
TEST_CASE("load mesh from libigl and test mesh topology", "[test_topology_2d]")
{
    ...
    igl::read_triangle_mesh("/mnt/ff7e01f4-89ad-40d7-a113-112e01c9fd93/siqi/wildmeshing/data/fan.obj", V, F);
    Eigen::Ref<Mesh::RowVectors3l> RefF = Eigen::Ref<Mesh::RowVectors3l>{F};
