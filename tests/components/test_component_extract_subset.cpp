...
std::map<long, std::vector<long>> get_connection(const wmtk::TriMesh& tm, std::set<long>& index_set)
{
    ...
    for (long edgeindex : index_set) {
        ...
        long v1 =
            wmtk::components::internal::find_vertex_index<wmtk::TriMesh>(tm, edgeVertexList[0]);
        long v2 =
            wmtk::components::internal::find_vertex_index<wmtk::TriMesh>(tm, edgeVertexList[1]);
