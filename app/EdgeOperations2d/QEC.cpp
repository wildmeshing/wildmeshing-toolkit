...
Eigen::MatrixXd Edge2d::EdgeOperations2d::compute_Q_f(wmtk::TriMesh::Tuple& f_tuple)
{
    ...
    Eigen::Vector3d A = vertex_attrs->m_attributes[conn_indices[0].vid()].pos;
    Eigen::Vector3d B = vertex_attrs->m_attributes[conn_indices[1].vid()].pos;
    Eigen::Vector3d C = vertex_attrs->m_attributes[conn_indices[2].vid()].pos;
...
{
    Eigen::Vector3d v = vertex_attrs->m_attributes[v_tuple.vid()].pos;
