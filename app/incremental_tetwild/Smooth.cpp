...
bool tetwild::TetWild::smooth_after(const Tuple& t)
{
    ...
    */
    ...
    bool preserve_geo =
        m_params.preserve_geometry &&
        (m_vertex_attribute[vid].m_is_on_surface || m_vertex_attribute[vid].m_is_on_open_boundary);
...
//                     edge_param.origin).dot(edge_param.direction);
...
//                 double dist =
//                     (m_vertex_attribute[vid].m_posf -
//                     collection.a_pos_f).dot(collection.normal_f);
