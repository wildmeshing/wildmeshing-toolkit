...
bool TriMeshSwapEdgeOperation::execute()
{
    ...
    // Tuple collapse_input = m_mesh.switch_tuple(
    //     m_mesh.switch_tuple(
    //         m_mesh.switch_tuple(split_result, PrimitiveType::Vertex),
    //         PrimitiveType::Edge),
    //     PrimitiveType::Face);
    ...
    // } else {
    //     m_output_tuple = m_mesh.switch_tuple(
    //         m_mesh.switch_tuple(m_output_tuple, PrimitiveType::Face),
