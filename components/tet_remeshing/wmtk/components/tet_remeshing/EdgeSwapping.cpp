...
void face_attribute_tracker(
    ...
    const TetRemeshingMesh::FaceAttCol& m_face_attribute,
...
void tracker_assign_after(
    ...
    TetRemeshingMesh::FaceAttCol& m_face_attribute)
{
...
size_t TetRemeshingMesh::swap_all_edges_32()
{
    igl::Timer timer;
    double time;
    timer.start();
...
bool TetRemeshingMesh::swap_edge_before(const Tuple& t)
{
...
bool TetRemeshingMesh::swap_edge_after(const Tuple& t)
{
...
size_t TetRemeshingMesh::swap_all_faces()
{
    igl::Timer timer;
    double time;
    timer.start();
...
bool TetRemeshingMesh::swap_face_before(const Tuple& t)
{
...
bool TetRemeshingMesh::swap_face_after(const Tuple& t)
{
...
size_t TetRemeshingMesh::swap_all_edges_all()
{
    igl::Timer timer;
    double time;
    timer.start();
...
size_t TetRemeshingMesh::swap_all_edges_44()
{
    igl::Timer timer;
    double time;
    timer.start();
...
bool TetRemeshingMesh::swap_edge_44_before(const Tuple& t)
{
...
double TetRemeshingMesh::swap_edge_44_energy(
...
bool TetRemeshingMesh::swap_edge_44_after(const Tuple& t)
{
...
size_t TetRemeshingMesh::swap_all_edges_56()
{
    igl::Timer timer;
    double time;
    timer.start();
...
bool TetRemeshingMesh::swap_edge_56_before(const Tuple& t)
{
...
double TetRemeshingMesh::swap_edge_56_energy(
    const std::vector<std::array<size_t, 4>>& tets,
    const int op_case)
{
    double max_energy = -1;
...
bool TetRemeshingMesh::swap_edge_56_after(const Tuple& t)
{
