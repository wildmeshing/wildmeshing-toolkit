    ...
    PrimitiveType simplex_type)
{
    ...
    case PrimitiveType::Tetrahedron:
        return tet_mesh::simplex_index_from_valid_index(valid_tuple_index, simplex_type);
    case PrimitiveType::Triangle:
        return tri_mesh::simplex_index_from_valid_index(valid_tuple_index, simplex_type);
    case PrimitiveType::Edge:
        return edge_mesh::simplex_index_from_valid_index(valid_tuple_index, simplex_type);
