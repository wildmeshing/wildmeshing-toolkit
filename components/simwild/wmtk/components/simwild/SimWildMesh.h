...
public:
    ...
    /// SimWild's target is per tag, so this normalizes each cell by its own before the shared
    /// optimizer compares one cell against another. See TetOptimizerMesh::quality_rel.
