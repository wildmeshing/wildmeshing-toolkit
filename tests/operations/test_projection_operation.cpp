...
TEST_CASE("test_projection_operation", "[operations][.]")
{
    ...
    SECTION("multimesh")
    {
        ...
        auto child_input_pos_handle = register_and_transfer_positions(pos_handle, *child_input_ptr);
        auto child_bnd_pos_handle = register_and_transfer_positions(pos_handle, *child_bnd_ptr);
