...
// int wmtk::TriMesh::find_next_empty_slot_t()
// {
...
// int wmtk::TriMesh::find_next_empty_slot_v()
// {
...
// void wmtk::TriMesh::split_all_edges() {
...
// bool wmtk::TriMesh::split_edge(const Tuple &loc0)
// {
// 	return false;
...
//     // loc1.print_info();//todo: split previous edges, the later edges (tuple) need to be updated
//     // loc2.print_info();
// 	// //
