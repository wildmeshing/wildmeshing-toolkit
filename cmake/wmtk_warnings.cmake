...
add_library(wmtk_warnings INTERFACE)
add_library(wmtk::warnings ALIAS wmtk_warnings)
...
foreach(FLAG IN ITEMS ${MY_FLAGS})
    ...
    if(IS_SUPPORTED_${FLAG_VAR})
        target_compile_options(wmtk_warnings INTERFACE ${FLAG})
    endif()
endforeach()
