...
EdgeMesh::EdgeMesh()
    : Mesh(1)
    , m_ve_handle(register_attribute_nomesh<int64_t>("m_ve", PrimitiveType::Vertex, 1))
    , m_ev_handle(register_attribute_nomesh<int64_t>("m_ev", PrimitiveType::Edge, 2))
    , m_ee_handle(register_attribute_nomesh<int64_t>("m_ee", PrimitiveType::Edge, 2))
{}
