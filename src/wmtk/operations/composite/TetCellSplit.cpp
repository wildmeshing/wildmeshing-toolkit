...
std::vector<Simplex> TetCellSplit::execute(const Simplex& simplex)
{
    ...
    const auto first_split_simplicies = EdgeSplit::execute(Simplex::edge(simplex.tuple()));
    ...
    const auto second_split_simplicies = EdgeSplit::execute(Simplex::edge(second_split_input));
    ...
    const auto third_split_simplicies = EdgeSplit::execute(Simplex::edge(third_split_input));
    ...
    const auto first_collapse_simplicies =
        EdgeCollapse::execute(Simplex::edge(first_collapse_input));
    ...
    const auto second_collapse_simplicies =
        EdgeCollapse::execute(Simplex::edge(second_collapse_input));
