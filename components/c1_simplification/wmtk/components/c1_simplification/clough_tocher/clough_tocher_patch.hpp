...
public:
    ...
    Eigen::Matrix<double, 12, 3> m_boundary_data; // p0, p1, p2, G01, G10, G12, G21, G20, G02, N01,
                                                  // N12,N20, for x, y, z
    std::array<Eigen::Matrix<double, 10, 3>, 3> m_CT_coeffs; // constant ct matrices for 3 sub tris
