...
//     auto pos_handle = surface_mesh.get_attribute_handle<double>("vertices",
//     PrimitiveType::Vertex); auto pos_accessor =
//     surface_mesh.create_accessor(pos_handle.as<double>());
