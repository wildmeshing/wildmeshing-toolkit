...
OffsetDiffTagInvariant::OffsetDiffTagInvariant(
    ...
    const MeshAttributeHandle<long>& split_todo_handle,
    ...
    , m_split_todo_handle(split_todo_handle)
...
{
    ConstAccessor<long> split_todo_accessor = mesh().create_accessor(m_split_todo_handle);
    return split_todo_accessor.const_vector_attribute(t)(0) == 1;
