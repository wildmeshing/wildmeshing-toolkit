...
// double wmtk::AMIPS2D_energy(const feature::FeatureElement &feature, const double t, const std::array<double, 6>& T)
// {
...
// double wmtk::AMIPS2D_jacobian(const feature::FeatureElement &feature, const double t, const std::array<double, 6>& T)
// {
//     const auto pt = feature.eval(t);
//     const std::array<double, 6> tmp = {{
//         pt.x, pt.y,
...
// double wmtk::AMIPS2D_hessian(const feature::FeatureElement &feature, const double t, const std::array<double, 6>& T)
// {
//     const auto pt = feature.eval(t);
//     const std::array<double, 6> tmp = {{
//         pt.x, pt.y,
