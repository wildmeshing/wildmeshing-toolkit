#include "Swap23EnergyBeforeInvariantDouble.hpp"
#include <wmtk/Mesh.hpp>
#include <wmtk/function/utils/amips.hpp>
#include <wmtk/utils/orient.hpp>

namespace wmtk {
Swap23EnergyBeforeInvariantDouble::Swap23EnergyBeforeInvariantDouble(
    const Mesh& m,
...
bool Swap23EnergyBeforeInvariantDouble::before(const simplex::Simplex& t) const
{
    ...
    std::array<Eigen::Vector3<double>, 5> positions = {
